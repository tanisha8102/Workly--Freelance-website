...
export default function BlogPage({ showFeaturedOnly = false, showBanner = true }: BlogPageProps) {
  ...
  const events = [
    {
      id: 1,
      title: "Ziro Mobile App Beta Tester Launching Ceremonials",
      date: "24 NOV",
      category: "MOBILE APP",
    ...
    {
      id: 2,
      title: "Manage Over 500 Employees Clearly with Mr. Samuel",
      date: "22 NOV",
      category: "BUSINESS",
      description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
      featured: true,
    ...
    {
      id: 3,
      title: "Ziro Annually Monthly Meetup: How to Increase Productivity",
      date: "21 NOV",
      category: "ACCOUNTING",
      description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
      featured: true,
    ...
    {
      id: 4,
      title: "Annual Financial Planning Summit",
      date: "21 NOV",
      category: "FINANCE",
      description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
      featured: false,
